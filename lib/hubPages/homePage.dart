...
//       .get(Uri.parse('https://api.petfinder.com/v2/animals'), headers: {
//     HttpHeaders.authorizationHeader: 'Bearer ${dotenv.env['PETFINDER_API']}',
//   });
...
//     return Animal(
//       id: json['animals.id'],
//       organization_id: json['animals.organization_id'],
//     );
//   }
// }
...
//           'Bearer ${dotenv.env["PETFINDER_API"]}';
//       return next(request);
//     },
//   ]);
